...
Open panels retain their measured layout bounds when gamepad prompts or other child controls hide, including while inventory's More menu is open. Panel size changes trigger fresh measurement; closing restores native placement and clears the saved bounds.
