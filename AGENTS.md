...
- **Conversation models:** Gossip, quest, trainer, and merchant interactions display the NPC on the left and your character on the right, in fixed screen-relative positions behind menus. Merchant/inventory switching preserves their placement. Models use current unit appearances and native standing animations; exact world movement or emote synchronization is unavailable. They do not intercept input and hide after the interaction closes. This feature works independently of Voiceover.
